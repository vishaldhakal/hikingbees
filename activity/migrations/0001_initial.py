# Generated by Django 4.1.4 on 2023-02-03 07:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, upload_to='')),
                ('image_alt_description', models.CharField(default='Alt Description', max_length=200)),
                ('activity_category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='activity.activitycategory')),
            ],
        ),
        migrations.CreateModel(
            name='ActivityImage',
