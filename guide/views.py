...
from .models import TravelGuide,GuideAuthour
from .serializers import TravelGuideSerializer,TravelGuideSlugSerializer,TravelGuideSmallSerializer,GuideAuthourSerializer
