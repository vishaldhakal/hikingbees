...
ALLOWED_HOSTS = ['ecdd-103-163-182-154.ngrok.io','king-prawn-app-t9tni.ondigitalocean.app','localhost','127.0.0.1']
...
CSRF_TRUSTED_ORIGINS = ['https://ecdd-103-163-182-154.ngrok.io','https://king-prawn-app-t9tni.ondigitalocean.app','http://127.0.0.1']
